...
void run(int argc, char** argv)
{
    ...
    const double all_size_in_gb = sizeof(unsigned int) * 3.0 * width * height / 1024 / 1024 / 1024;
...

    {
        ...
        std::cout << "a + b matrix VRAM bandwith (in GB/s) - " << all_size_in_gb / stats::median(times) << " GB/s" << std::endl;
