...
void run(int argc, char** argv)
{
...

    {
        ...
        double mem_size_gb = sizeof(unsigned int) * 3 * width * height / 1024.0 / 1024.0 / 1024.0;
        std::cout << "a + b matrix kernel median VRAM bandwidth: " << mem_size_gb / stats::median(times) << " GB/s" << std::endl;
