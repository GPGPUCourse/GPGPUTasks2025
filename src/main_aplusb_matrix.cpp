...
void run(int argc, char** argv)
{
...

    {
        ...
        double mem_size_gb = (3. * sizeof(unsigned int) * width * height / 1024. / 1024. / 1024.);
        std::cout<<"Memory bandwidth (bad kernel): "<< mem_size_gb / stats::median(times) <<" GB/s\n";;
...

    {
        ...
        double mem_size_gb = (3. * sizeof(unsigned int) * width * height / 1024. / 1024. / 1024.);
        std::cout<<"Memory bandwidth (good kernel): "<< mem_size_gb / stats::median(times) <<" GB/s\n";;
