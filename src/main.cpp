...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			default: std::cout << "Unknown (" << deviceType << ")"; break;
			}
			std::cout << std::endl;
			...
			std::cout << "      Global mem cacheline size: " << globalMemCachelineSize << " bytes" << std::endl;

			std::cout << std::endl;
			if(deviceIndex + 1 < devicesCount) std::cout << std::endl;
		}
	}
