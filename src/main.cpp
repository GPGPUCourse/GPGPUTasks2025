...
std::string getDeviceTypeInString(cl_device_type deviceType);
...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			std::cout << "            Type: " << getDeviceTypeInString(deviceType) << std::endl;
			...
			float deviceMemorySizeMB = static_cast<float>(deviceMemorySize) / (1024.0 * 1024.0);
			std::cout << std::fixed << std::setprecision(2);
			std::cout << "            Memory size: " << deviceMemorySizeMB << " (MB)" << std::endl;
			...
			std::cout << "            Address: " << deviceAddressBits << " bits" << std::endl;
		}
	}
