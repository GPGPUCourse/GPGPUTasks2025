...
const char* getDeviceTypeName(cl_device_type device_type) {
...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			clGetDeviceInfo(device, CL_DEVICE_VENDOR, deviceVendorSize, deviceVendor.data(), nullptr);
			...
			cl_ulong memSize = 0;
			clGetDeviceInfo(device, CL_DEVICE_GLOBAL_MEM_SIZE, sizeof(cl_ulong), &memSize, nullptr);
			...
			std::cout << "    Device cache: " << cacheSize / 1024 << " Kb" << std::endl;
		}
	}
