...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		// OCL_SAFE_CALL(clGetPlatformInfo(platform, 4815, 0, nullptr, &platformNameSize));
		...
		std::cout << "    Platform vendor: " << platformVendor.c_str() << std::endl;
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_NAME, sizeof(deviceName), deviceName, nullptr));
			...
			std::cout << "    Device #" << deviceIndex << ":\n"
			          << "      Name: " << deviceName << "\n"
			          << "      Type: " << typeStr << "\n"
			          << "      Global Memory: " << (globalMemSize / (1024 * 1024)) << " MB\n"
