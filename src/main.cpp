...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
            ...
            std::cout << "\n    Device #" << (deviceIndex + 1) << "/" << devicesCount << std::endl;
            ...
            double globalMemSizeMB = static_cast<double>(globalMemSize) / (1024 * 1024);
            std::cout << "        Global memory size: " << globalMemSizeMB << " MB" << std::endl;
		}
	}
