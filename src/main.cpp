...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		{
			cl_device_id id = deviceIds[deviceIndex];
			// TODO 2.2
			...
			OCL_SAFE_CALL(clGetDeviceInfo(id, CL_DEVICE_NAME, 0, nullptr, &deviceNameLength));
			std::vector<unsigned char> deviceName(deviceNameLength);
			OCL_SAFE_CALL(clGetDeviceInfo(id, CL_DEVICE_NAME, deviceNameLength, deviceName.data(), nullptr));
