...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_GLOBAL_MEM_SIZE, sizeof(cl_ulong), &localMemorySize, nullptr));
			localMemorySize /= 1024 * 1024;
			std::cout << "        Device Memory Size: " << localMemorySize << "MB" << std::endl;
			...
			std::cout << "        Device Unified Memory: ";
			if (unifiedMemory)
