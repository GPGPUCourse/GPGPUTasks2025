...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		std::cout << "    Platfrom vendor: " << platformVendor.data() << std::endl;
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_GLOBAL_MEM_SIZE, sizeof(cl_ulong), &device_global_mem_size, nullptr));
			std::cout << "        Device global memory size (MB): " << device_global_mem_size / 1024 / 1024 << std::endl;
			...
			std::cout << "        Device profile: " << device_profile.data() << std::endl;

			cl_bool device_compiler_available;
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_COMPILER_AVAILABLE, sizeof(cl_bool), &device_compiler_available, nullptr));
			std::cout << "        Device compiler available: " << (device_compiler_available ? "Yes" : "No") << std::endl;
		}
	}
