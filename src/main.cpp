...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		// OCL_SAFE_CALL(clGetPlatformInfo(platform, 239, 0, nullptr, &platformNameSize)); // ошибка CL_INVALID_VALUE -30
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			std::cout << "        Device global memory size in Mb: " << globalMemSize / (1024 * 1024)<< std::endl;
			...
			std::cout << "        Device local memory size in Kb: " << localMemSize / 1024 << std::endl;
