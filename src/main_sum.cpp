...
void run(int argc, char** argv)
{
    ...
    times1.push_back(t1.elapsed());
    }
    
    double memory_size_gb1 = sizeof(unsigned int) * n / 1024.0 / 1024.0 / 1024.0;
    std::cout << "input_gpu.writeN(values.data(), n) median time , PCI-E bandwidth::  " << (memory_size_gb1)/stats::median(times1) << " GB/s" << std::endl;
}
