...
void run(int argc, char** argv)
{
    ...
    double total_memory_size = sizeof(unsigned int) * n / 1024.0 / 1024.0 / 1024.0;
    double median_time = stats::median(pci_e_times);
    std::cout << "PCI-E bandwidth: " << total_memory_size / median_time << " GB/s" << std::endl;
