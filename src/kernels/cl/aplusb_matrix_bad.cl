                     ...
                     unsigned int height)
{
    ...
    const unsigned int column = index / height, row = index % height;
    const unsigned int transposed_index = row * width + column;

    c[transposed_index] = a[transposed_index] + b[transposed_index];
}
