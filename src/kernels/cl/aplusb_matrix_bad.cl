                     ...
                     unsigned int height)
{
    ...
    const unsigned int row_idx = get_global_id(0);
    const unsigned int col_idx = get_global_id(1);

    const unsigned int res_idx = row_idx * height + col_idx;
    c[res_idx] = a[res_idx] + b[res_idx];
}
