...
void radix_sort_01_local_counting(const gpu::WorkSize &workSize, const gpu::gpu_mem_32u &input, gpu::gpu_mem_32u &count_buffer, unsigned int n, unsigned int bits_offset);
...
void radix_sort_04_scatter(const gpu::WorkSize &workSize, const gpu::gpu_mem_32u &input, const gpu::gpu_mem_32u &prefix_sum, gpu::gpu_mem_32u &output, unsigned int n, unsigned int bits_offset);
}
