...
void prefix_sum_01_sum_reduction(const gpu::WorkSize &workSize, const uint32_t* pow2_sum, uint32_t* next_pow2_sum, unsigned int n);
void prefix_sum_02_prefix_accumulation(const gpu::WorkSize &workSize, const gpu::gpu_mem_32u& array, const gpu::gpu_mem_32u &global_offset, const gpu::gpu_mem_32u &pow2_sum, gpu::gpu_mem_32u &prefix_sum_accum, unsigned int n, unsigned int pow2);
}
